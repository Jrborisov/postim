...
class resizecrop
{
    ...
    public function resizePostImg($file_input, $file_output, $w_o=700, $h_o=0, $percent = false)
    {
        list($w_i, $h_i, $type) = getimagesize($file_input);
        ...
        if(!imagecopyresampled($img_o, $img, 0, 0, 0, 0, $w_o, $h_o, $w_i, $h_i)){
            $this->imgError=false;
            return;
        }
        if ($type == 2) {
