...
class Twitter extends AbstractAdapter
{
    ...
    {
        define('CONSUMER_KEY', 'IXuThMKRMMLS1s8tsKc6dlioq');
        define('CONSUMER_SECRET', 'RcsL58rQyFTrBquk8L1w9b3fsfpzj0DBEbKIoO4LmoSTTUZR1x');
        ...
        define('CALLBACK_URL', 'http://postim.by/site/loginSocial?social=twitter');
...
// генерируем ссылку аутентификации
        ...
        return $link = AUTHORIZE_URL . '?oauth_token=' . $oauth_token;
    }
    ...
    {
        return $this->provider. $this->userInfo['id'];
    }
    public function getAvatar(){
        return 'http://postim.by/images/default_big_photo.png';
    }
